    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p className="text-sm ">
            Course by <span className="text-blue-600 underline">VKTCODER</span>
          </p>
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <img
                        className={`transform transition-tranform ${
        ...
        {/*right column*/}
        <div className="max-w-[420px] z-10 shadow-white rounded-t border  md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          {playerData ? (
            <YouTube
          ...
          <div className="p-5">
            ...
            <button className="md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium">
              {isAlreadyEnrolled ? "Arlready Enrolled" : "Enroll Now"}
            </button>
            ...
            <div className="pt-6">
              ...
              <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
                ...
                <li>Step-by-step , hand-0n project guidance.</li>
